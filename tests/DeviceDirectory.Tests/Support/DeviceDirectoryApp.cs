...
/// <c>ConnectionStrings__DeviceDirectory</c> (as <c>devdir_user</c>) and <c>DEV_JWT_SIGNING_KEY</c>.
/// </summary>
public sealed class DeviceDirectoryApp(string connectionString, string? signingKey) : WebApplicationFactory<Program>
{
    public LogCapture Logs { get; } = new();

    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        builder.UseSetting("ConnectionStrings:DeviceDirectory", connectionString);
