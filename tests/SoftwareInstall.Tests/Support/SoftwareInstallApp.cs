...
/// <c>Blob__ConnectionString</c>, <c>Blob__Container</c> and <c>DEV_JWT_SIGNING_KEY</c>.
/// </summary>
public sealed class SoftwareInstallApp(string connectionString, string container, string? signingKey) : WebApplicationFactory<Program>
{
    public LogCapture Logs { get; } = new();

    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        builder.UseSetting("Blob:ConnectionString", connectionString);
        builder.UseSetting("Blob:Container", container);
